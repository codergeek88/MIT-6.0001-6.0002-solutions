...
class WeightedEdge(Edge):
    ...
    def __str__(self):
        print_format = Edge.__str__(self) + " (" + str(self.total_distance) + ", " + str(self.outdoor_distance) + ")"
        return print_format
...
class Digraph(object):
    ...
    def add_edge(self, edge):
        ...
        if edge_source in self.nodes and edge_dest in self.nodes:
            if edge_source not in self.edges:
                self.edges[edge_source] = []
